            ...
            <div className="mx-auto max-w-7xl">
                ...
                <div className="mb-6">
                    <button
                        ...
                        className="mb-3 inline-flex items-center gap-2 text-sm font-medium text-green-700 transition hover:text-green-800"
                    >
                        <svg
                            className="h-4 w-4"
                            fill="none"
                ...
                <div className="grid grid-cols-1 gap-6 lg:grid-cols-5">
                    ...
                    <div className="lg:col-span-3">
                        <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
                            ...
                            {/* Task Header */}
                            <div className="border-b border-green-100 bg-green-50 px-5 py-5 sm:px-6">
                                ...
                                <div className="flex flex-col gap-4">
                                    ...
                                    <div className="flex items-center justify-between gap-4">
                                        ...
                                        <span className="rounded-full bg-white px-3 py-1 text-xs font-semibold text-slate-600 shadow-sm ring-1 ring-inset ring-slate-200">
                                            {task?.status}
                                        </span>
                                    ...
                                    {canManageTask && (
                                        <div className="flex flex-wrap gap-2">
                                            ...
                                            <Button
                                                ...
                                                className="rounded-lg bg-green-600 px-3 py-2 text-xs font-semibold text-white shadow-sm transition hover:bg-green-700 sm:px-4 sm:text-sm"
                                            >
                                                Update
                                            </Button>
                                            ...
                                            <Button
                                                ...
                                                className="rounded-lg bg-red-600 px-3 py-2 text-xs font-semibold text-white shadow-sm transition hover:bg-red-700 disabled:cursor-not-allowed disabled:opacity-60 sm:px-4 sm:text-sm"
                                            >
                                                {isDeleting
                                                    ? "Deleting..."
                                                    : "Delete"}
                                ...
                                <div className="space-y-5 p-5 sm:p-6">
                                            ...
                                            {canUpdateStatus ? (
                                                <div className="mt-3 space-y-3">
                                                    ...
                                                    <Select
                                                        ...
                                                        className="w-full rounded-lg border border-slate-200 bg-white px-3 py-2.5 text-sm font-medium text-slate-700 outline-none transition focus:border-green-500 focus:ring-2 focus:ring-green-100"
                                                    />
                                                ...
                                                <span className="mt-3 inline-flex rounded-full bg-green-100 px-3 py-1.5 text-sm font-semibold text-green-700">
                                                    {task?.status}
                                                </span>
                                            )}
                                    ...
                                    <div className="rounded-xl border border-slate-200 bg-slate-50 p-5">
                                        ...
                                        <div className="mt-3 flex items-center gap-3">
                                            ...
                                            <div className="flex h-11 w-11 shrink-0 items-center justify-center overflow-hidden rounded-full bg-green-100 font-semibold text-green-700">
                    ...
                    <div className="lg:col-span-2">
                        ...
                        <div className="flex h-[650px] flex-col overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm lg:h-[calc(100vh-8rem)] lg:min-h-[600px]">

                            {/* Header */}

                            <div className="shrink-0 border-b border-green-100 bg-green-50 px-5 py-5">
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-slate-500">
                                            Discuss this task with project
                                            members.
                                        </p>
                                    </div>
                            ...
                            <div className="shrink-0 border-b border-slate-100 p-4 sm:p-5">
                                ...
                                <textarea
                                    ...
                                    className="w-full resize-none rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm text-slate-700 outline-none transition placeholder:text-slate-400 focus:border-green-500 focus:bg-white focus:ring-2 focus:ring-green-100"
                                />
                            ...
                            {isLoading ? (
                                ...
                                <div className="min-h-0 flex-1 space-y-3 overflow-y-auto bg-slate-50/60 p-4 sm:p-5">
                                        ...
                                        comments.map((comment) => (
                                            ...
                                            >
                                                ...
                                                <div className="flex items-start gap-3">
                                                    ...
                                                    <div className="flex h-9 w-9 shrink-0 items-center justify-center overflow-hidden rounded-full bg-green-100 text-sm font-semibold text-green-700">
                        ...
                        <div className="w-full max-w-lg overflow-hidden rounded-2xl bg-white shadow-2xl">
                            ...
                            <div className="flex items-start justify-between border-b border-slate-100 px-5 py-5 sm:px-6">
                                ...
                                <div>
                                    ...
                                    <p className="mt-1 text-sm text-slate-500">
                                        Select a project member to assign this
                                        task.
                                    </p>
                                </div>
                                ...
                                <Button
                                    ...
                                    className="rounded-lg p-2 text-xl leading-none text-slate-400 transition hover:bg-slate-100 hover:text-slate-700"
                                >
                                    ×
                                </Button>
                            ...
                            <div className="max-h-[60vh] space-y-2 overflow-y-auto p-4 sm:p-6">
                                ...
                                {projectMembers.map((member) => (
                                    <div
                                        key={member._id}
                                        className="flex items-center justify-between gap-3 rounded-xl border border-slate-200 bg-slate-50 p-3 transition hover:border-green-200 hover:bg-green-50"
                                    >
                                        ...
                                        <Button
                                            ...
                                            className="shrink-0 rounded-lg bg-green-600 px-3 py-2 text-xs font-semibold text-white transition hover:bg-green-700 disabled:cursor-not-allowed disabled:opacity-50 sm:px-4 sm:text-sm"
                                        >
                                            {assignTaskMutation.isPending
                                                ? "..."
                                                : "Assign"}
