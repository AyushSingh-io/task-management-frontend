                    ...
                    <div className="mb-4 flex flex-col gap-3 border-b border-indigo-100 pb-3 sm:flex-row sm:items-center sm:justify-between">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <Button
                                ...
                                className="rounded-sm bg-indigo-600 px-4 py-2 text-sm text-white hover:bg-indigo-700"
                            >
                                + Add Member
                            </Button>
                        ...
                        <>
                            ...
                            <div className="mt-6 flex flex-col gap-3">
                                ...
                                <Button
                                    ...
                                    className="rounded-sm bg-indigo-600 px-4 py-2 text-sm font-medium text-white transition hover:bg-indigo-700"
                                >
                                    Change Role
                                </Button>
